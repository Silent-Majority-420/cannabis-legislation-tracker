...
# Expanded to catch enforcement, budget, licensing, and market-related bills
POLICY_TERMS = [
    # Financial/Banking
    ...
    # Enforcement/Compliance (ADDED - catches SB25-246 type bills)
    ...
    # Budget/Funding (ADDED - catches budget bills affecting cannabis programs)
            ...
            try:
                ...
                if bill_response.status_code == 200:
                    ...
                    if bill_detail.get('status') == 'OK':
                        ...
                        # Map numeric status code to readable status
